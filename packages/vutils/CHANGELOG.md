...
This log was last generated on Fri, 06 Feb 2026 06:33:50 GMT and should not be manually modified.

## 1.0.22
Fri, 06 Feb 2026 06:33:50 GMT
...
- feat: add `cartesianToPolar` util
...
- fix: fix bug at `pointAt` when x,y is undefined



## 0.18.9
Fri, 24 May 2024 08:23:48 GMT

### Updates

- feat: add `calculateMaxRadius()` and `findBoundaryAngles()`
...
- fix: fix params type of `calculateAnchorOfBounds()`
...
- feat: optimize `maxInArray` and `minInArray`
...
- feat: lineHeight can be a string
