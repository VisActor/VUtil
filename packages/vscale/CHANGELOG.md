...
-  fix: linear scale clone get incorrect domain
...
- feat: add customTicksFunc in linearScale and support a new ticks function called wilkinson extended
